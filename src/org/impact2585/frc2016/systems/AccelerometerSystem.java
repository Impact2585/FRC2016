...
public class AccelerometerSystem implements RobotSystem, Runnable{
	...
	public void init(Environment environ) {
		...
		SmartDashboard.putBoolean("Connection Successful: ", connectionSuccessFull);
	...
	/**Sets if the accelerometer is connected
	 * @param connect whether the connection was successful
	 */
	public void setSuccessfulConnection(boolean connect) {
		connectionSuccessFull = connect;
	}
